...
```markdown
![APT Installed](https://github.com/PankajSwami-Cyber/PankajSwami-Cyber/blob/main/Labs/linux-package-management-lab/screenshots/2%20APT%20Installed.png?raw=true)
